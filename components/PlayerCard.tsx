    ...
    >
      {onToggleCompare && (
        <button
          ...
          className="absolute top-3 left-3 inline-flex h-6 w-6 items-center justify-center rounded border transition focus:outline-none focus:ring-2 focus:ring-brand-green bg-brand-green"
        >
          {isCompareSelected && (
            <svg
